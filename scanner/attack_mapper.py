...
CATEGORY_MAP: Dict[tuple, tuple] = {
    # Persistence
    ("persistence", "registry_run"):        ("T1547.001", "Boot or Logon Autostart: Registry Run Keys"),
    ("persistence", "startup_folder"):      ("T1547.001", "Boot or Logon Autostart: Startup Folder"),
    ("persistence", "scheduled_task"):      ("T1053.005", "Scheduled Task/Job: Scheduled Task"),
    ("persistence", "service"):             ("T1543.003", "Create or Modify System Process: Windows Service"),
    ("persistence", "wmi_subscription"):    ("T1546.003", "Event Triggered Execution: WMI Event Subscription"),
    # Heuristics
    ("heuristics", "suspicious_cmdline"):   ("T1059",     "Command and Scripting Interpreter"),
    ("heuristics", "high_entropy"):         ("T1027",     "Obfuscated Files or Information"),
    ("heuristics", "double_extension"):     ("T1036.007", "Masquerading: Double File Extension"),
    ...
    ("processes", "unbacked_memory"):       ("T1055.001", "Process Injection: Dynamic-link Library Injection"),
    ("processes", "hollowed_image"):        ("T1055.012", "Process Injection: Process Hollowing"),
    # Network
    ...
    ("credential", "sam"):                  ("T1003.002", "OS Credential Dumping: Security Account Manager"),
    # Rootkit
    ...
    # ADS
    ("ads", "alternate_data_stream"):       ("T1564.004", "Hide Artifacts: NTFS File Attributes"),
    # Browser
    ("browser", "extension"):               ("T1176",     "Browser Extensions"),
    ("browser", "hosts_file"):              ("T1565.001", "Data Manipulation: Stored Data Manipulation"),
    ("browser", "malicious_bookmark"):      ("T1176",     "Browser Extensions"),
    # NPM / supply chain
    ("npm", "typosquat"):                   ("T1195.001", "Supply Chain Compromise: Compromise Software Dependencies"),
    ("npm", "dependency_confusion"):        ("T1195.001", "Supply Chain Compromise: Compromise Software Dependencies"),
    # Events
    ("events", "logon_anomaly"):            ("T1078",     "Valid Accounts"),
    ("events", "privilege_escalation"):     ("T1068",     "Exploitation for Privilege Escalation"),
    ("events", "account_creation"):         ("T1136",     "Create Account"),
    ("events", "audit_log_cleared"):        ("T1070.001", "Indicator Removal: Clear Windows Event Logs"),
    # YARA
    ("yara", "yara_match"):                 ("T1203",     "Exploitation for Client Execution"),
    # Defender
    ("defender", "quarantine"):             ("T1562.001", "Impair Defenses: Disable or Modify Tools"),
    # Windows Security
    ("winsec", "firewall_disabled"):        ("T1562.004", "Impair Defenses: Disable or Modify System Firewall"),
    ("winsec", "defender_disabled"):        ("T1562.001", "Impair Defenses: Disable or Modify Tools"),
    ("winsec", "uac_disabled"):             ("T1548.002", "Abuse Elevation Control Mechanism: Bypass User Account Control"),
    ("winsec", "audit_gap"):                ("T1562.002", "Impair Defenses: Disable Windows Event Logging"),
    # KEV
...
KEYWORD_MAP: List[tuple] = [
    ...
    (["shadow copy", "vssadmin", "wbadmin"],
     ("T1490",     "Inhibit System Recovery")),
    (["taskkill", "net stop", "sc stop"],
     ("T1489",     "Service Stop")),
    ...
    (["token impersonat", "impersonat"],
     ("T1134",     "Access Token Manipulation")),
    (["net user", "net localgroup", "dsadd user"],
